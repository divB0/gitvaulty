...
| IDE plugins | **Supported:** VS Code, through the official [GitVaulty extension](https://marketplace.visualstudio.com/items?itemName=divB0.gitvaulty), and JetBrains IDEs through the official [GitVaulty plugin](https://plugins.jetbrains.com/plugin/33659-gitvaulty/versions/stable?noRedirect=true). Both edit decrypted documents without plaintext repository siblings. | **Supported:** VS Code, through the official [Cottage extension](https://marketplace.visualstudio.com/items?itemName=sayanarijit.vscode-plugin-cottage). It installs Cottage, configures Copilot and Claude safety hooks, encrypts Explorer files, and edits `.cott.age` files through temporary plaintext siblings that it re-encrypts on save and cleans when the editor loses focus or closes. No dedicated JetBrains/IntelliJ plugin is documented. |
...
[JetBrains plugin](https://plugins.jetbrains.com/plugin/33659-gitvaulty/versions/stable?noRedirect=true). This
