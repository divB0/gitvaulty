...
reuse supported SSH keys, or prefer a tool that never changes Git state for you.
...
safe plaintext migration, temporary command workflow, and VS Code integration provide the access
lifecycle around the encrypted files.
